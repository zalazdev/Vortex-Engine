...
local function load_test()
	...
	_WINDOWS[1]:construct( 600 , 600 , "Sprite diagonally move" )
	_WINDOWS[1]:init() 
    ...
    local function move_sprite( self )
           ...
           if _KEYBOARD:isThisPressed( "Right" ) then 

              self:move( 2 , 0 )

           end

           if _KEYBOARD:isThisPressed( "Up" ) then

              self:move( 0 , -2 )

           end 

           if _KEYBOARD:isThisPressed( "Down" ) then 
